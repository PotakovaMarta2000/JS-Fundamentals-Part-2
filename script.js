...
//Фразой «если ...» определяется условие.Если условие true выполняется определенный блок кода
//Если условие не выполняется, то нужно смотреть на фразу «то...», «В противном случае ...», когда она есть
