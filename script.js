...
// Анонимные функция. Функция у которой нет имени, 
//а значит ссылаться на нее и использовать в последствии не можем, вызываем "здесь-сейчас"
//Чаще всего она записывается в переменную и дальше с ней происходит работа
...
// В данном примере анонимная функция выступает в качестве аргумента функции setTimeout(), 
//и выведет сообщение через пять секунд после загрузки страницы.
